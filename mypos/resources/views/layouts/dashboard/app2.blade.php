...
<link rel="stylesheet" href="{{asset('dashboard/css/cairofont.css')}}">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{route('dashboard.index')}} "><i class="fa fa-link"></i> <span>@lang('site.dashboard')</span></a></li>

        @if(auth()->user()->hasPermission('read_users'))
            <li class="active"><a href="{{route('dashboard.users.index')}} "><i class="fa fa-link"></i> <span>@lang('site.users')</span></a></li>
        @endif
